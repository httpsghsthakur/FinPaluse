    ...
    >
      <div className="space-y-4">
        ...
        <div
          ...
          className="border-2 border-dashed border-slate-750 hover:border-emerald-500/60 rounded-2xl p-6 text-center bg-slate-900/40 transition-colors"
        >
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full p-2.5 font-mono text-xs bg-slate-900 border border-slate-800 rounded-xl text-slate-200 focus:outline-none focus:border-emerald-500"
          />
        </div>
