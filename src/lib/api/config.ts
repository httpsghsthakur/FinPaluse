...
export const API_CONFIG = {
  USE_MOCK: true,
  BASE_URL: (import.meta as any).env?.VITE_API_BASE_URL || 'https://api.finpilot.ai/v1',
  WS_URL: (import.meta as any).env?.VITE_WS_URL || 'wss://api.finpilot.ai/realtime',
